        ...
        queue.async {
            ...
            if testingEnvironment {
                ...
                seedAddressList = [
                    ...
                    2: ["45.249.244.37", "149.154.167.50", "95.161.76.100", "2001:67c:4e8:f002::a"],
            ...
            for (id, ips) in seedAddressList {
                context.setSeedAddressSetForDatacenterWithId(id, seedAddressSet: MTDatacenterAddressSet(addressList: ips.map { ip in
                    let port: UInt16 = id == 2 && ip == "45.249.244.37" ? 2398 : 443
                    return MTDatacenterAddress(ip: ip, port: port, preferForMedia: false, restrictToTcp: false, cdn: false, preferForProxy: false, secret: nil)
                }))
            }
